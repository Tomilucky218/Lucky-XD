...
lucky({
  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(config.MENU_IMAGE_URL || "https://files.catbox.moe/vje5wl.jpeg", {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            body: config.DESCRIPTION || "POWERED BY LUCKY TECH HUB",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/vje5wl.jpeg", // Static image URL
