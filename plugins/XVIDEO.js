...
╰────────────────┈⊷\n\n🔢 *Please reply with the number of your choice*\n\n`;
        ...
        const sentMsg = await conn.sendMessage(from, {
            image: { url: videos[0].image || 'https://files.catbox.moe/vje5wl.jpeg' },
            caption: listText,
            contextInfo: {
                forwardingScore: 999,
                isForwarded: true,
...
> ㋛︎ Powered By Lucky Tech Hub`;
                ...
                const optionMsg = await conn.sendMessage(from, {
                    image: { url: xv_info.result.image || 'https://files.catbox.moe/vje5wl.jpeg' },
                    caption: desc,
                    contextInfo: {
                        forwardingScore: 999,
                        isForwarded: true,
                            ...
                            await conn.sendMessage(from, {
                                ...
                                contextInfo: {
                                    externalAdReply: {
                                        ...
                                        thumbnailUrl: xv_info.result.image || "https://files.catbox.moe/vje5wl.jpeg",
