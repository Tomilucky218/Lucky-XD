...
https://files.catbox.moe/vje5wl.jpeg({
  pattern: 'version',
  ...
  try {
    ...
    // Remote version data
    const repoRawURL = 'https://raw.githubusercontent.com/luckytechhub/Lucky-XD/main/data/version.json';
...
👑 *Owner:* https://github.com/luckytechhub

${updateStatus}
`.trim();

    await conn.sendMessage(from, {
      image: { url: 'https://files.catbox.moe/vje5wl.jpeg' },
      caption,
      contextInfo: {
